        ...
        <motion.section
            ...
            ">
                ...
                <motion.p
                    variants={fadeInUp}
                    className="
                    mt-6 text-neutral-400 max-w-xl">
                    {HERO_CONTENT.subHeading}
                </motion.p>
                <motion.div
                    variants={fadeInUp}
                    className="mt-6 space-x-4">
                    <a href="#" className='inline-block bg-blue-600 
                    hover:bg-blue-500
                ...
                <motion.div
                    variants={fadeIn} className="py-10">
                ...
                <motion.div
                    variants={fadeIn}
                    className="mt-12">
                    <img src={heroImg} alt="Streamer Saas Interface" className='w-full h-auto rounded-3xl border border-neutral-800' />
                </motion.div>
            </div>
        </motion.section>
    )
